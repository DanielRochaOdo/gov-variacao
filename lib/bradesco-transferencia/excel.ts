...
export async function generateModelWorkbook(): Promise<Buffer> {
  ...
  const instructions: Array<[string, string]> = [
    ...
    ["dv_agencia_favorecido", "Na forma 05, obrigatorio: exatamente 1 digito (coluna AN)."],
    ...
    ["forma_iniciacao", "Obrigatorio. 01=Telefone, 02=E-mail, 03=CPF/CNPJ, 04=Aleatoria, 05=Dados bancarios."],
    ...
    ["Regras forma 05", "Se AM ou AN estiver fora do padrao (AM=4 ou 5 digitos, AN=1 digito), o TXT nao e gerado."],
  ];
